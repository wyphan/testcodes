...
!==============================================================================
! These are manually written (WYP)
!==============================================================================
...
! Initialize MAGMA and create queue
  SUBROUTINE magma_init_f
    ...
    ! Create MAGMA queue on device 0
    ! TODO: account for multiple devices
    CALL magma_queue_create( 0, queue )
